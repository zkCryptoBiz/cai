...
export function getContext(siteLevelSeoData, pageLevelSeoData, userPatternSchema) {
    var _a;
    var _b;
    var _c = siteLevelSeoData.context, context = _c === void 0 ? {} : _c, _d = siteLevelSeoData.mainPageId, mainPageId = _d === void 0 ? false : _d;
    var defaultUrl = (_b = context[CONTEXT_PROPS.DEFAULT_URL]) === null || _b === void 0 ? void 0 : _b.replace(/\/$/, '');
    var pageName = pageLevelSeoData.pageName, title = pageLevelSeoData.title, description = pageLevelSeoData.description, ogImage = pageLevelSeoData.ogImage, ogImageWidth = pageLevelSeoData.ogImageWidth, ogImageHeight = pageLevelSeoData.ogImageHeight, indexPage = pageLevelSeoData.indexPage, _e = pageLevelSeoData.currentPageUrl, currentPageUrl = _e === void 0 ? defaultUrl : _e, _f = pageLevelSeoData.pageId, pageId = _f === void 0 ? false : _f, tpaPageId = pageLevelSeoData.tpaPageId;
