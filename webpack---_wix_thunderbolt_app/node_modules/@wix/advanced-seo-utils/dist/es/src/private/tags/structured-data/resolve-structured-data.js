...
export var resolveStructuredData = function (tags, context) {
    ...
    return __spreadArray(__spreadArray([], nonSDataTags, true), parentSchemas.map(function (parentSchema) {
        var childSchema = sdTags.find(function (tag) { return tag.meta.parentSchemaType === parentSchema.meta.schemaType; });
        return childSchema && !childSchema.disabled
            ? mergeParentChildSchemas(parentSchema, childSchema)
            : parentSchema;
    }), true);
};
