...
var PlatformControllerFlowAPI = /** @class */ (function (_super) {
    ...
    function PlatformControllerFlowAPI(_a) {
        var viewerScriptFlowAPI = _a.viewerScriptFlowAPI, controllerConfig = _a.controllerConfig, widgetId = _a.widgetId, componentId = _a.componentId, componentName = _a.componentName, biLogger = _a.biLogger, translations = _a.translations, fedopsConfig = _a.fedopsConfig, sentryConfig = _a.sentryConfig, panoramaClient = _a.panoramaClient, windowAPI = _a.windowAPI, locationAPI = _a.locationAPI, siteAPI = _a.siteAPI, seoAPI = _a.seoAPI;
        var _this = this;
        var _b;
