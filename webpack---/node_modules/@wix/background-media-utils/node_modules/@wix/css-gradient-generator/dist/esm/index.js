...
const { GRADIENT_LINEAR, GRADIENT_CONIC, GRADIENT_CIRCLE, } = gradientConstants.TYPES;
const { RADIAL_GRADIENT, CONIC_GRADIENT, LINEAR_GRADIENT, } = gradientConstants.CSS_FUNC;
const { REPEATING, DEG, AT_CENTER, CIRCLE, ELLIPSE, FROM, PERCENTAGE, } = gradientConstants;
/**
 *
 ...
 */
function generateColorStop({ color, opacity, size }, { alpha = 1, resolveColor }) {
    let colorStopColor = '';
    let colorStopSize = '';
    if (color) {
        if (resolveColor) {
