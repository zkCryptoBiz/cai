...
export interface IPageDidLoadHandler {
	pageDidLoad: (pageInfo: { pageId: string; contextId: string }) => Promise<void> | void
}
...
const PageDidLoadHandlerSym = Symbol('PageDidLoadHandler')
...
export const LifeCycle = {
	...
	PageDidLoadHandler: PageDidLoadHandlerSym,
