...
export default withDependencies<PlatformInitializer>(
	[PlatformWarmupDataManagerSymbol, Props, Structure, ComponentsStylesOverridesSymbol, LoggerSymbol, PlatformWorkerPromiseSym, ExperimentsSymbol, CompsLifeCycleSym],
	(
