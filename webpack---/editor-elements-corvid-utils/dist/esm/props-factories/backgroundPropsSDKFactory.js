...
import { createMediaSrc, getScrollEffect, getMediaDataFromSrc, getVideoDataByVideoId, hasVideo, CORVID_BG_VIDEO_DEFAULTS as BG_VIDEO_DEFAULTS, } from '../media';
...
const _backgroundPropsSDKFactory = ({ setProps, props, metaData, compRef }) => {
    ...
    return {
        get background() {
            return {
                get src() {
                    const { fillLayers: _fillLayers } = props;
                ...
                set src(newSrc) {
                    ...
                    const { hasBgScrollEffect, bgEffectName } = getScrollEffect(fillLayers);
