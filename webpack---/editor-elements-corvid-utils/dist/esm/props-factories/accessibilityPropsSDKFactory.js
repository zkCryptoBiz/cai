...
import { createAriaLabelSDK, createAtomicSDK, createBusySDK, createCurrentSDK, createDescribedBySDK, createErrorMessageSDK, createExpandedSDK, createLabelledBySDK, createLiveSDK, createOwnsSDK, createRelevantSDK, createRoleSDK, screenReaderSDKFactory, createTabIndexSDK, createControlsSDK, createRoleDescriptionSDK, createAriaHiddenSDK, createAriaPressedSDK, createAriaHaspopupSDK, createAriaRequiredSDK, } from './accessibilitySDKFactories';
...
export const createAccessibilityPropSDKFactory = ({ enableAriaLabel = true, enableAriaDescribedBy = true, enableAriaLabelledBy = true, enableAriaAtomic = false, enableAriaBusy = false, enableAriaHidden = false, enableAriaPressed = false, enableAriaHaspopup = false, enableAriaCurrent = false, enableAriaExpanded = false, enableAriaLive = false, enableAriaOwns = false, enableAriaControls = false, enableAriaRoleDescription = false, enableAriaRelevant = false, enableRole = false, enableTabIndex = false, enableAriaErrorMessage = false, enableScreenReader = false, enableAriaRequired = false, } = {}) => api => {
    const sdkFactories = [];
