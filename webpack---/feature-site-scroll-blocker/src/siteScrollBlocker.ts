import { siteScrollBlocker as siteScrollBlockerBase } from '@wix/thunderbolt-scroll-blocker'
...
const siteScrollBlockerFactory = (
	...
	if (experiments?.['specs.thunderbolt.scrollBlockerPackage']) {
		const scrollBlocker = siteScrollBlockerBase({
			...
			shouldBlockScrollWithOverflowHidden: experiments?.['specs.thunderbolt.blockSiteScrollWithOverflowHidden'],
		})
		siteScrollBlockerExports.export({
